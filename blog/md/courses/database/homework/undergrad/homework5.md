...
This homework is to train your brain muscle to run a lot of SQL commands and we are to create a small banking system with some data.

* The following is a small banking system. Please run all of them including DDL and DML and create the schemas in your db. (20 pts)
* And try to analyze the correlations with the tables. And think about how to visualize the relations using ER diagram. (20 pts)
* A decent word or PDF reports about the ER diagram of all. (20 Pts)
* Screenshots to show and describe the tables you created using SQL synax `desc` or `describe` in the SQL code editor. Screenshots of the list of tables on the left of DBeaver to list all the tables does not count. (20 pts)
* Connect from SQL Terminal (The black terminal console) and describe any tables using `desc` (10 pts).
* Write about 50-200 words about what `index` in database is, and regarding some tables you created, what indexes you would like to create, and please provide syntax, and explain why. You do not have to create indexes for all the tables, just take some table and provide a real index creation (5 pts) and explain why you would create it. (5 pts)

## A small banking system  

Please execute the following in your SQL code editor in DBeaver. (DBeaver is easy to work with than the terminal.)
